...
- Campaign brief keys: objective, schemeName, schemeCategory, audience, channels (min 1), market, performanceFigures: array of `{"value":"...","period":"..."}` objects (may be empty; e.g. `"14.2% CAGR over 3 years"` → `{"value":"14.2% CAGR","period":"3 years"}`), claims (array, may be empty)
